...
<html lang="es">
    ...
    <head>
        ...
        <title> HammaCraft - Catálogo </title>
            ...
            <div>
                <form>
                    <select onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);"  class="menu_catalogo">
                        <option value="/php/catalogo.php" selected>Todos</option>
                        ...
                        <option value="lat/php/catalogos_especificos/catalogo_grandes.php">Grandes</option>
