...
<head>
	...
	<title> HammaCraft - Catálogo: Youtubers </title>
    ...
    <main>
        ...
        <div>
            <form class="menu-catalogo">
                <select onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);"  class="menu_catalogo">
                    ...
                    <option value="/php/catalogos_especificos/catalogo_youtubers.php" selected>Youtubers</option>
                </select>
            </form>
        </div>
        ...
        <div class = "catalogo">
            ...
            <?php
                ...
                $category3 = "Youtuber"; //Todos, Pokemon, Digimon, Youtuber
