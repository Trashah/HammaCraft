...
<head>
	...
	<title> HammaCraft - Catálogo: Medianos </title>
...
<body class = "body-hammacraft">
    ...
    <main>
        ...
        <div>
            <form class="menu-catalogo">
                <select onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);"  class="menu_catalogo">
                    ...
                    <option value="/php/catalogos_especificos/catalogo_medianos.php" selected>Medianos</option>
        ...
        <div class = "catalogo">
            ...
            <?php
                $category1 = "Medianos"; //Todos, Chicos, Medianos, Grandes
